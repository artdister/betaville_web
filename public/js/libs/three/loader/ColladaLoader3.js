...
THREE.ColladaLoader.prototype = {
	...
	parse: function ( text, baseUrl ) {
			...
			if ( asset.upAxis == 'Z_UP' ) {
				scene.traverse(function(e){
					if(e instanceof THREE.Mesh){
						e.geometry.applyMatrix(new THREE.Matrix4().makeRotationX( -Math.PI / 2));
						e.updateMatrix();
					}
			...
			if ( asset.upAxis == 'X_UP' ) {
				scene.traverse(function(e){
					if(e instanceof THREE.Mesh){
						e.geometry.applyMatrix(new THREE.Matrix4().makeRotationZ( -Math.PI / 2));
						e.updateMatrix();
					}

...
( function () {
	...
	THREE.TransformGizmoRotate = function () {
		...
		this.update = function ( rotation, eye2 ) {
			...
			worldRotation.copy( this.planes[ "XZ" ].rotation );
			...
			if ( _mode === "translate" ) {
				...
				if ( scope.space === "local" ) {
					...
					if ( scope.axis === "XYZ" ) {
						...
						if ( scope.axis === "X" ) scope.object.scale.x = oldScale.x * ( 1 + point.x / 500 );
						if ( scope.axis === "Y" ) scope.object.scale.y = oldScale.y * ( 1 + point.y / 500 );
						if ( scope.axis === "Z" ) scope.object.scale.z = oldScale.z * ( 1 + point.z / 500 );

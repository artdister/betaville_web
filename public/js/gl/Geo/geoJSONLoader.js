...
//get Address from geo pos
//https://search.mapzen.com/v1/reverse?api_key=search-rmYJFBw&point.lat=53.0312072&point.lon=8.8345921&boundary.circle.radius=100
...
geoJSONLineLoader.prototype.load = function(json, loadded){
	...
	for(var i = 0; i < streetsArr.length; i++){
		...
		for(obj in this.widthData){
			//obj == streetsArr[i].properties. highway
			if(obj == streetsArr[i].properties.type){
